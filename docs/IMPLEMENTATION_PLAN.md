...
- Remaining shared-definition caveat: this prevents UI/test constant drift for the temporary Web Audio model, but the model still differs materially from the Python export engine.
